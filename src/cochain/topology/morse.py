...
def _prepare_inputs(
    ...
    splx_scalar_fields = (
        to_np(scalar_field.view(-1, 1)),
        to_np(scalar_field[mesh.edges]),
        to_np(scalar_field[mesh.tris]),
        to_np(scalar_field[mesh.tets]),
    )
    ...
    codim1_face_signs = (
        ...
        to_np(mesh.cbd[1].values),
        to_np(mesh.cbd[2].values),
    )
