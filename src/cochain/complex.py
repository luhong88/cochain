...
class SimplicialComplex:
    ...
    # TODO: check if this works as expected for tri meshes
    @cached_property
    def all_canon_tris_idx(self) -> Integer[t.LongTensor, "tet 4"]:
        return tet_topology.tet_tri_face_idx(self.tets, self.tris, self.n_verts)
