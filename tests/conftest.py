...
@pytest.fixture
def two_tris_mesh() -> Simplicial2Complex:
    return datasets.load_two_tris_mesh()


@pytest.fixture
def square_mesh() -> Simplicial2Complex:
    return datasets.load_square_mesh()


@pytest.fixture
def tent_mesh() -> Simplicial2Complex:
    return datasets.load_tent_mesh()


@pytest.fixture
def tet_mesh() -> Simplicial2Complex:
    return datasets.load_tet_mesh()


@pytest.fixture
def icosphere_mesh() -> Simplicial2Complex:
...
@pytest.fixture
def flat_annulus_mesh() -> Simplicial2Complex:
